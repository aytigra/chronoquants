defmodule ChronoquantsWeb.Pow.AccentViewHelpers do
  ...
  """
  @spec pow_accent_provider_links(Conn.t()) :: [HTML.safe()]
  def pow_accent_provider_links(conn) do
  ...
  """
  @spec authorization_link(Conn.t(), atom()) :: tuple()
  ...
  """
  @spec deauthorization_link(Conn.t(), atom()) :: tuple()
